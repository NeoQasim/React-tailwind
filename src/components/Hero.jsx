        ...
        <>
            ...
            <div className='text-white'>
                <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col gap-3 justify-center">
                    ...
                    <div className="bg-none flex text-2xl sm:text-3xl md:text-5xl lg:text-5xl justify-center nd gap-6">
                        <p>Lorem ipsum dolor sitsits
                        </p>
                        <Typed className='shadow-lg shadow-yellow-400' strings={["Neo", "Qasim", "Khan"]} typeSpeed={60} backSpeed={50} loop />
                    </div>
                    <p className='text-slate-500 text-xl font-semibold'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, accusantium. Ullam dolore nesciunt quasi.!</p>
                </div>
            </div>
        </>
    )
